...
def main():
    ...
    forward_button['command'] = lambda: mqtt_client.send_message('forward', [float(left_speed_entry.get()), float(right_speed_entry.get())])
    ...
    e_button['command'] = lambda: mqtt_client.send_message('say_it', ['exit'])
